...
public class Sample_baiduActivity extends MapActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bMapManager = new BMapManager(Sample_baiduActivity.this);
        //必须加载Key
        bMapManager.init(Key, new MKGeneralListener() {
			...
			public void onGetPermissionState(int arg0) {
				...
				if(arg0 == 300){
					Toast.makeText(Sample_baiduActivity.this, "输入的Key有错", 1).show();
				}
			}
		...
		public void onLocationChanged(Location location) {
			...
			if (location != null){
				...
				Toast.makeText(Sample_baiduActivity.this,"lon="+mApp.lon+",lat="+mApp.lat,1).show(); 
...
//		  mLocationOverlay.disableCompass()  // 关闭指南针
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item.getItemId()== R.id.referesh){
			 ...
			 intent.setClass(Sample_baiduActivity.this, ScrollLayoutActivity.class);
