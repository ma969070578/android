...
//					startActivity(intent1);
		...
		new AlertDialog.Builder(this).setTitle("性别").setIcon(
			     ...
			     new DialogInterface.OnClickListener() {
			      public void onClick(DialogInterface dialog, int which) {
			    	...
			    	EdjTools.writeShare(MyInfoActivity.this, "user_sex", msex);
			        dialog.dismiss();
			        getDataSource1();
	...
	private List<Map<String, Object>> getDataSource1() {
		...
		String name = EdjTools.readShare(MyInfoActivity.this, "user_name");
		if (EdjTools.isNull(name)) {
			name = "请编辑";
		}
		map.put("img", name);
		map_list1.add(map);
		...
		String sex = EdjTools.readShare(MyInfoActivity.this, "user_sex");
		if (EdjTools.isNull(sex)) {
			sex = "请选择";
		}
		map.put("img", sex);
		map_list1.add(map);
		...
		String address = EdjTools.readShare(MyInfoActivity.this, "user_address");
		if (EdjTools.isNull(address)) {
			address = "请选择";
		}
		map.put("img", address);
		map_list1.add(map);
